#!/bin/sh
# vscode i fucking hate you bruh
# also do setup haxelib if you haven't, i really don't feel like adding in the commands that do it.
...
haxelib --quiet --skip-dependencies install hxvlc 2.0.1
