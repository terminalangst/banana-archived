...
class ClientPrefs {
	...
	public static function loadPrefs() {
		...
		if(Main.counter != null) Main.counter.visible = data.showFPS;
	...
	{
		final emptyArray = [];
		FlxG.sound.muteKeys = turnOn ? muteKeys : emptyArray;
		FlxG.sound.volumeDownKeys = turnOn ? volumeDownKeys : emptyArray;
		FlxG.sound.volumeUpKeys = turnOn ? volumeUpKeys : emptyArray;
	}
}
